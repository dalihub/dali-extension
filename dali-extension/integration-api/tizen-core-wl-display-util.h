#ifndef DALI_EXTENSION_INTEGRATION_API_TIZEN_CORE_WL_DISPLAY_UTIL_H
#define DALI_EXTENSION_INTEGRATION_API_TIZEN_CORE_WL_DISPLAY_UTIL_H
...
#endif // DALI_EXTENSION_INTEGRATION_API_TIZEN_CORE_WL_DISPLAY_UTIL_H
