...
// EXTERNAL INCLUDES
#include <wv_back_forward_list_item.h>
...
public:
   ...
   * @brief Constructor.
   */
  TizenWebEngineBackForwardListItem(wv_back_forward_list_item_h item, bool willItemBeDeleted = false);
...
private:
  wv_back_forward_list_item_h mWvBackForwardListItem;

  bool mWillItemBeDeleted; // if true, WV api will be called  to unref the item
};
