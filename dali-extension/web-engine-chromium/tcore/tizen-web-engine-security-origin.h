...
public:
   ...
   * @brief Constructor.
   */
  TizenWebEngineSecurityOrigin(wv_security_origin_h origin);
   ...
   */
  wv_security_origin_h GetSecurityOrigin() const;

private:
  wv_security_origin_h wvSecurityOrigin;
};
