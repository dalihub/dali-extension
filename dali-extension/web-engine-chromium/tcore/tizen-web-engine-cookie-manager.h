...
public:
   ...
   * @brief Constructor.
   */
  TizenWebEngineCookieManager(wv_cookie_manager_h manager);
...
private:
   ...
   */
  static void OnChangesWatch(void* eventInfo, void* data);

private:
  wv_cookie_manager_h                                                      mWvCookieManager;
  wv_cookie_accept_policy_e                                                mCookieAcceptancePolicy;
