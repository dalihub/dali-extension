...
public:
   ...
   * @brief Constructor.
   */
  TizenWebEngineContext(wv_context_h context, bool isIncognito);
...
private:
   ...
   */
  static void OnRequestIntercepted(wv_context_h context, wv_intercept_request_h request, void* data);
   ...
   * @param[in] data data for callback
   */
  static void OnSecurityOriginsAcquired(GList* origins, void* data);
   ...
   * @param[in] data data for callback
   */
  static void OnFormPasswordsAcquired(GList* list, void* data);
   ...
   * false otherwise.
   */
  static bool OnMimeOverridden(const char* url, const char* mime, char** newMime, void* data);
