...
TizenWebEngineBackForwardListItem::TizenWebEngineBackForwardListItem(wv_back_forward_list_item_h item, bool willItemBeDeleted)
: mWvBackForwardListItem(item),
...
TizenWebEngineBackForwardListItem::~TizenWebEngineBackForwardListItem()
{
  ...
  {
    wv_back_forward_list_item_unref(mWvBackForwardListItem);
  }
}

std::string TizenWebEngineBackForwardListItem::GetUrl() const
{
  const char* url = wv_back_forward_list_item_url_get(mWvBackForwardListItem);
  return url ? std::string(url) : std::string();
}

std::string TizenWebEngineBackForwardListItem::GetTitle() const
{
  const char* title = wv_back_forward_list_item_title_get(mWvBackForwardListItem);
  return title ? std::string(title) : std::string();
}

std::string TizenWebEngineBackForwardListItem::GetOriginalUrl() const
{
  const char* url = wv_back_forward_list_item_original_url_get(mWvBackForwardListItem);
  return url ? std::string(url) : std::string();
}
