...
public:
   ...
   * @brief Constructor.
   */
  TizenWebEngineContextMenuItem(wv_context_menu_item_h item);
   ...
   */
  wv_context_menu_item_h GetMenuItem() const;

private:
  wv_context_menu_item_h wvContextMenuItem;
};
