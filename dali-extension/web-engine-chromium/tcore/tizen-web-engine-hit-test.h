...
#include <wv_hit_test_internal.h>
#include <string>
...
public:
   ...
   * @brief Constructor.
   */
  TizenWebEngineHitTest(wv_hit_test_h hitTest, bool needMemoryBeFreed);
...
private:
   ...
   */
  static void IterateAttributes(gpointer key, gpointer value, gpointer userData);

private:
  wv_hit_test_h               wvHitTest;
  bool                        isMemoryFreedByWv;
