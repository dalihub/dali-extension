...
public:
   ...
   * @brief Constructor.
   */
  TizenWebEngineRequestInterceptor(wv_intercept_request_h interceptor);
...
private:
   ...
   */
  static void IterateRequestHeaders(gpointer key, gpointer value, gpointer userData);

private:
  wv_intercept_request_h wvRequestInterceptor;
  wv_view_h              wvWebView;
