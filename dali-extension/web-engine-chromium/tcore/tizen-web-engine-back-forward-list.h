...
// EXTERNAL INCLUDES
#include <wv_back_forward_list.h>
...
public:
   ...
   * @brief Constructor.
   */
  TizenWebEngineBackForwardList(wv_back_forward_list_h list);
  ...
  {
    mWvBackForwardList = list.mWvBackForwardList;
    return *this;
  };
...
private:
  wv_back_forward_list_h mWvBackForwardList;
};
} // namespace Plugin
} // namespace Dali
