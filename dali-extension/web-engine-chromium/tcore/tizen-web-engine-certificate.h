...
// EXTERNAL INCLUDES
#include <wv_certificate_internal.h>
#include <string>
...
public:
   ...
   * @brief Constructor.
   */
  TizenWebEngineCertificate(wv_certificate_policy_decision_h decision);

  /**
   * @brief Constructor.
   */
  TizenWebEngineCertificate(wv_certificate_info_h info);
...
private:
  wv_certificate_policy_decision_h wvCertificatePolicyDecision;
  wv_certificate_info_h            wvCertificateInfo;
};
